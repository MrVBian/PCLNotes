...
CMAKE_SOURCE_DIR = /home/bian/document/github/PCLNotes/点云分割/7最小分割算法_分割点云_基于距离加权的最小图分割算法/1同一图颜色区分

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = /home/bian/document/github/PCLNotes/点云分割/7最小分割算法_分割点云_基于距离加权的最小图分割算法/1同一图颜色区分
...
CMakeFiles/show.dir/show.cpp.o: show.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/bian/document/github/PCLNotes/点云分割/7最小分割算法_分割点云_基于距离加权的最小图分割算法/1同一图颜色区分/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/show.dir/show.cpp.o"
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/show.dir/show.cpp.o -c /home/bian/document/github/PCLNotes/点云分割/7最小分割算法_分割点云_基于距离加权的最小图分割算法/1同一图颜色区分/show.cpp
...
CMakeFiles/show.dir/show.cpp.i: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/bian/document/github/PCLNotes/点云分割/7最小分割算法_分割点云_基于距离加权的最小图分割算法/1同一图颜色区分/show.cpp > CMakeFiles/show.dir/show.cpp.i
...
CMakeFiles/show.dir/show.cpp.s: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/bian/document/github/PCLNotes/点云分割/7最小分割算法_分割点云_基于距离加权的最小图分割算法/1同一图颜色区分/show.cpp -o CMakeFiles/show.dir/show.cpp.s
...
show: CMakeFiles/show.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/bian/document/github/PCLNotes/点云分割/7最小分割算法_分割点云_基于距离加权的最小图分割算法/1同一图颜色区分/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable show"
...
CMakeFiles/show.dir/depend:
	cd /home/bian/document/github/PCLNotes/点云分割/7最小分割算法_分割点云_基于距离加权的最小图分割算法/1同一图颜色区分 && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/bian/document/github/PCLNotes/点云分割/7最小分割算法_分割点云_基于距离加权的最小图分割算法/1同一图颜色区分 /home/bian/document/github/PCLNotes/点云分割/7最小分割算法_分割点云_基于距离加权的最小图分割算法/1同一图颜色区分 /home/bian/document/github/PCLNotes/点云分割/7最小分割算法_分割点云_基于距离加权的最小图分割算法/1同一图颜色区分 /home/bian/document/github/PCLNotes/点云分割/7最小分割算法_分割点云_基于距离加权的最小图分割算法/1同一图颜色区分 /home/bian/document/github/PCLNotes/点云分割/7最小分割算法_分割点云_基于距离加权的最小图分割算法/1同一图颜色区分/CMakeFiles/show.dir/DependInfo.cmake --color=$(COLOR)
