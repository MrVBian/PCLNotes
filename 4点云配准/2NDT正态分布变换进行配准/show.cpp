...
int main( int argc, char** argv ){
	...
	if ( pcl::io::loadPCDFile<pcl::PointXYZ> ( "../../datas/room_scan1.pcd", *target_cloud ) == -1 ){
	...
	if ( pcl::io::loadPCDFile<pcl::PointXYZ> ( "../../datas/room_scan2.pcd", *input_cloud ) == -1 ){
